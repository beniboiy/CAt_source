        ...
        <div class="banner" id="header">Caribbean &nbsp;&nbsp;&nbsp;<span>AUTO</span>tech</div>
            <table>
                <tr id="menubar">
                    ...
                    <td class="menubar" id="auctionsTab" style="color: white; border-left: 2px solid white; border-right: 2px solid white;">Auctions</td>
                    <td class="menubar" id="diyTab" onclick="jumpTo('diy')">DIY</td>
                    <td class="menubar" id="forumTab" onclick="jumpTo('forum')">Forum</td>
